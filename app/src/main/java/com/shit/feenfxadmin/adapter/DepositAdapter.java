...
public class DepositAdapter extends FirestorePagingAdapter<DepositStatusModel,DepositAdapter.ViewHolder> {
    ...
    public DepositAdapter(@NonNull FirestorePagingOptions<DepositStatusModel> options, SwipeRefreshLayout mSwipeRefreshLayout) {
        super(options);
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.deposit_report_layout,
                parent, false);
    ...
    public void setOnItemClickListener(DepositAdapter.OnItemClickListener listener) {
