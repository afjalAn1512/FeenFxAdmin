...
public class WithdrawStatusAdapter extends FirestorePagingAdapter<WithdrawModel, WithdrawStatusAdapter.ViewHolder> {
    ...
    public WithdrawStatusAdapter(@NonNull FirestorePagingOptions<WithdrawModel> options, SwipeRefreshLayout mSwipeRefreshLayout) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull ViewHolder holder, int position, @NonNull WithdrawModel model) {
        ...
        holder.accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FirebaseFirestore.getInstance().collection("Withdraw").document(model.getWithdraw_id()).get()
                        .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                            ...
                            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                ...
                                FirebaseFirestore.getInstance().collection("Withdraw").document(model.getWithdraw_id()).update(status);
                                refresh();
                            }
                        });
                ...
                FirebaseFirestore.getInstance().collection("userDetails").document(model.getUsername()).get()
                        .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                            ...
                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                ...
                                Previous = documentSnapshot.getString("commission_balance");

                                // PreviousCommission = documentSnapshot.getLong("commission");

                                Long Total = Long.parseLong(Objects.requireNonNull(Previous)) - Long.parseLong(model.getAmount());
...
//                                }
                                ...
                                Map<String, Object> status = new HashMap<>();
                                status.put("commission_balance", String.valueOf(Total));
...
//                                }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.pending_withdraw_layout,
                parent, false);
    ...
    public void setOnItemClickListener(WithdrawStatusAdapter.OnItemClickListener listener) {
