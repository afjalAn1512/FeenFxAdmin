...
public class DepositStatusFragment extends Fragment {
    ...
    private DepositStatusAdapter buyerPostAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buyerPostAdapter = new DepositStatusAdapter(options, swipeRefreshLayout);
        ...
        buyerPostAdapter.setOnItemClickListener(new DepositStatusAdapter.OnItemClickListener() {
            @Override
