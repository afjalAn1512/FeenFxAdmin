...
public class TradingActivity extends AppCompatActivity {
    ...
    private TradingActivity activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(TradingActivity.this,MainActivity.class));
                finish();
            }
        });
...
//                tab.setCustomView(R.layout.custom_tab);
        ...
        for (int i = 0; i < tabLayout.getTabCount(); i++) {
            ...
            TextView tv = (TextView) LayoutInflater.from(TradingActivity.this)
    ...
    private void setupViewPager(ViewPager2 viewPager) {
        adapterNew = new ViewPagerAdapter(TradingActivity.this.getSupportFragmentManager(),
                activity.getLifecycle());
        adapterNew.addFragment(new BuyFragment(), "Buy");
        adapterNew.addFragment(new SellFragment(), "Sell");
