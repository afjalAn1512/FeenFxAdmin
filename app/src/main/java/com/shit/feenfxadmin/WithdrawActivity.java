...
public class WithdrawActivity extends AppCompatActivity {
    ...
    private WithdrawAdapter buyerPostAdapter;
...
//                            email.setText(emailA);
        ...
        buyerPostAdapter = new WithdrawAdapter(options, swipeRefreshLayout);
        ...
        buyerPostAdapter.setOnItemClickListener(new WithdrawAdapter.OnItemClickListener() {
            @Override
